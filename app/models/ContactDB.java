...
public class ContactDB {
  ...
  public static Contact add(ContactFormData fData) {
    ...
    if (fData.id == 0) {
      ...
      contact = new Contact(fData.firstName, fData.lastName, fData.telephone, id, fData.address);
      cdForm.put(id, contact);
    }
    else {
      contact = new Contact(fData.firstName, fData.lastName, fData.telephone, fData.id, fData.address);
